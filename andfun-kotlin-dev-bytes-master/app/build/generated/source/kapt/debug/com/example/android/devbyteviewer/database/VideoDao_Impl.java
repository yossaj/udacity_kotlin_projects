...
public final class VideoDao_Impl implements VideoDao {
  ...
  @Override
  public void insertAll(DatabaseVideo... videos) {
  ...
  public LiveData<List<DatabaseVideo>> getVideos() {
    ...
    return new ComputableLiveData<List<DatabaseVideo>>(__db.getQueryExecutor()) {
      private Observer _observer;

      @Override
      protected List<DatabaseVideo> compute() {
        if (_observer == null) {
          _observer = new Observer("databasevideo") {
            @Override
