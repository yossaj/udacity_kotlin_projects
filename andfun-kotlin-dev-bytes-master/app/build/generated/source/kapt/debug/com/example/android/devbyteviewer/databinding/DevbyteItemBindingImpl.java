...
public class DevbyteItemBindingImpl extends DevbyteItemBinding implements com.example.android.devbyteviewer.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.videoCallback == variableId) {
            ...
            setVideo((com.example.android.devbyteviewer.domain.Video) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVideo(@Nullable com.example.android.devbyteviewer.domain.Video Video) {
        this.mVideo = Video;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.android.devbyteviewer.domain.Video video = mVideo;
