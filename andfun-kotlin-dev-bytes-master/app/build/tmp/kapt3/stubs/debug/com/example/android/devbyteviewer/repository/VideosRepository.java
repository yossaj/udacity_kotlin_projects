...
public final class VideosRepository {
    ...
    private final androidx.lifecycle.LiveData<java.util.List<com.example.android.devbyteviewer.domain.Video>> videos = null;
    private final com.example.android.devbyteviewer.database.VideosDatabase database = null;
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<java.util.List<com.example.android.devbyteviewer.domain.Video>> getVideos() {
        return null;
    }
